  ...
  return (
    ...
    >
      <div className="auth-header">
        <div className="auth-bot-icon">
          <Bot size={28} className="icon-violet" />
        </div>
        <h2 className="auth-title">Welcome Back</h2>
        <p className="auth-subtitle">Continue your journey with AI.</p>
      </div>
      ...
      <div className="social-logins">
        <button className="btn btn-social group">
